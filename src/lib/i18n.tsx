...
const translations = {
  es: {
    ...
    auth: {
      ...
      loginSubtitle: "Ingresá con tu cuenta de VIVA CORE.",
      loginEmail: "Email",
      ...
      registerSubtitle: "Registrate para acceder a VIVA CORE.",
      registerButton: "Crear cuenta",
      registerLoading: "Creando cuenta…",
      registerSuccess: "Cuenta creada",
      registerSuccessSub: "Revisá tu correo {email} para confirmar la cuenta.",
      haveAccount: "¿Ya tenés cuenta?",
      login: "Iniciar sesión",
      logout: "Cerrar sesión",
      adminAccessDenied: "Acceso restringido",
      adminAccessDeniedSub: "No tenés permisos de administrador.",
    },
    dashboard: {
    ...
    feed: {
      composerPlaceholder: "¿Qué novedad querés compartir con el equipo, Braian?",
      post: "Publicar",
      photo: "Foto",
      milestone: "Hito",
      ...
      writeComment: "Escribí un comentario…",
      stories: "Proyectos del grupo",
      ...
      filterMine: "Míos",
      verbs: {
        briefing: "completó un briefing en",
        file: "subió un archivo a",
        comment: "comentó en",
        budget: "envió un presupuesto de",
        idea: "aprobó una idea en",
        milestone: "alcanzó un hito en",
      },
    },
    briefings: {
    ...
    form: {
      ...
      sectionOf: "Sección {cur} de {tot}",
      saveIdle: "Se guarda solo",
      saving: "Guardando…",
      saved: "Guardado",
      unsaved: "Sin guardar",
      received: "Briefing recibido",
      receivedSub:
        "Gracias por completar la información de {name}. Con estos datos vamos a diseñar una experiencia web alineada con la estrategia de la marca y los objetivos comerciales del grupo.",
      invalidLink: "Link no válido",
      invalidText:
        "Este enlace de briefing no corresponde a ningún proyecto. Verificá la URL o pedí uno nuevo.",
      goHome: "Ir al inicio",
      sections: {
        general: {
      ...
      fields: {
        ...
        "referencias.urls": {
          ...
          help: "Agreguen sitios que admiren, aunque sean de otros rubros.",
        },
        "referencias.porque": { label: "¿Qué les gusta de esas referencias?", help: "" },
        "identidad.activos": { label: "Ya cuentan con…", help: "" },
        "identidad.archivos": {
          label: "Subí los archivos que tengas (logo, manual, fotos…)",
          help: "",
        },
        ...
        "funcionalidades.detalle": {
          label: "¿Existe alguna funcionalidad específica que quieran implementar?",
          help: "",
        },
        ...
        "marketing-ideas.sensacion": {
          label: "¿Qué sensación debe transmitir la página al visitante?",
          help: "",
        },
        "marketing-ideas.accion": {
          label: "¿Qué acción quieren que haga el usuario al entrar?",
          help: "",
        },
        "marketing-ideas.persona": {
          label: "Si esta página fuera una persona, ¿cómo sería?",
          help: "",
        },
        "libre.notas": {
          label: "Escriban cualquier idea, inspiración o detalle importante",
          help: "",
        },
      },
    },
  ...
  pt: {
    ...
    auth: {
      ...
      loginSubtitle: "Entre com sua conta VIVA CORE.",
      loginEmail: "Email",
      loginPassword: "Senha",
      loginButton: "Entrar",
      ...
      registerSubtitle: "Cadastre-se para acessar o VIVA CORE.",
      registerButton: "Criar conta",
      registerLoading: "Criando conta…",
      registerSuccess: "Conta criada",
      registerSuccessSub: "Verifique seu email {email} para confirmar a conta.",
      haveAccount: "Já tem conta?",
      login: "Iniciar sessão",
      logout: "Sair",
      adminAccessDenied: "Acesso restrito",
      adminAccessDeniedSub: "Você não tem permissão de administrador.",
    },
    dashboard: {
    ...
    feed: {
      composerPlaceholder: "Qual novidade você quer compartilhar com a equipe, Braian?",
      post: "Publicar",
      photo: "Foto",
      milestone: "Marco",
      update: "Atualização",
      ...
      stories: "Projetos do grupo",
      shortcuts: "Atalhos",
      storage: "Armazenamento",
      storageUsed: "{used} de {total} usados",
      teamOnline: "Equipe online",
      online: "Online",
      away: "Ausente",
      loadMore: "Ver mais publicações",
      filterAll: "Tudo",
      filterMine: "Meus",
      verbs: {
        briefing: "concluiu um briefing em",
        file: "enviou um arquivo para",
        comment: "comentou em",
        budget: "enviou um orçamento de",
        idea: "aprovou uma ideia em",
        milestone: "alcançou um marco em",
      },
    },
    briefings: {
    ...
    form: {
      ...
      sectionOf: "Seção {cur} de {tot}",
      saveIdle: "Salvo automaticamente",
      saving: "Salvando…",
      saved: "Salvo",
      unsaved: "Sem salvar",
      received: "Briefing recebido",
      receivedSub:
        "Obrigado por preencher as informações de {name}. Com esses dados vamos criar uma experiência web alinhada com a estratégia da marca e os objetivos comerciais do grupo.",
      invalidLink: "Link inválido",
      invalidText:
        "Este link de briefing não corresponde a nenhum projeto. Verifique a URL ou solicite um novo.",
      goHome: "Ir ao início",
      sections: {
        general: {
          title: "Informações gerais",
          description: "O essencial da marca para entender quem são.",
        },
        objetivo: { title: "Objetivo do site", description: "Para que deve servir o site?" },
        referencias: {
          title: "Referências visuais",
          description: "Sites que vocês gostam e por quê.",
        },
        identidad: {
          title: "Identidade visual",
          description: "Que material de marca vocês já têm?",
        },
        estructura: { title: "Estrutura desejada", description: "Quais seções o site deve ter?" },
        funcionalidades: {
          title: "Funcionalidades especiais",
          description: "O que levaria o site a outro nível.",
        },
        contenido: { title: "Conteúdo", description: "Quem fornece os textos, imagens e vídeos?" },
        seo: {
          title: "SEO e Marketing",
          description: "Para posicionar e conectar com as campanhas.",
        },
        integraciones: { title: "Integrações", description: "Ferramentas a conectar com o site." },
        "marketing-ideas": {
          title: "Ideias da equipe de marketing",
          description: "A direção criativa que quase nunca é documentada.",
        },
      ...
      fields: {
        ...
        "referencias.urls": {
          ...
          help: "Adicionem sites que admiram, mesmo de outros segmentos.",
        },
        "referencias.porque": { label: "O que vocês gostam nessas referências?", help: "" },
        "identidad.activos": { label: "Vocês já têm…", help: "" },
        "identidad.archivos": {
          label: "Envie os arquivos que tiver (logo, manual, fotos…)",
          help: "",
        },
        ...
        "funcionalidades.detalle": {
          label: "Existe alguma funcionalidade específica que queiram implementar?",
          help: "",
        },
        ...
        "marketing-ideas.sensacion": {
          label: "Que sensação o site deve transmitir ao visitante?",
          help: "",
        },
        "marketing-ideas.accion": {
          label: "Que ação querem que o usuário faça ao entrar?",
          help: "",
        },
        "marketing-ideas.persona": {
          label: "Se este site fosse uma pessoa, como seria?",
          help: "",
        },
        "libre.notas": {
          label: "Escrevam qualquer ideia, inspiração ou detalhe importante",
          help: "",
        },
      },
    },
